package models.UlearnCSVParser;
import com.opencsv.*;
...
public class UlearnCsvParser {
    private final static Logger LOGGER = LogManager.getLogger(UlearnCsvParser.class);
    ...
    private ArrayList<models.Module> parseModules(String[] values, String[] themes, String[] exercisesNames, String[] maxGrades){
        int position = 8; // initial position
        String moduleName = null;
        ArrayList<models.Module> modules = new ArrayList<>();
        ...
        for(; position <= values.length; position++) {
            ...
            modules.add(new models.Module(moduleName, getExerciseGrade(exercises, ExerciseType.ACTIVITY),
